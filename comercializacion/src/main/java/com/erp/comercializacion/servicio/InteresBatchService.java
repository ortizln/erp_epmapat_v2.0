...
import com.erp.comercializacion.modelo.Intereses;           // ENTIDAD de % mensuales (anio, mes, porcentaje)
import com.erp.comercializacion.modelo.Tmpinteresxfac;     // ENTIDAD TMP donde persistimos el interés
import com.erp.comercializacion.repositorio.FacturasR;     // Proyección FacLite
import com.erp.comercializacion.repositorio.InteresesR;    // findByRango(...)
import com.erp.comercializacion.repositorio.TmpinteresxfacR;
