...
import com.erp.comercializacion.modelo.Fec_factura_detalles_impuestos;
import com.erp.comercializacion.servicio.Fec_factura_detalles_impuestosService;

@RestController
@RequestMapping("/api/facdetallesimpuestos")
