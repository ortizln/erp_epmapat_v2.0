...
import com.erp.comercializacion.modelo.administracion.Ventanas;
import com.erp.comercializacion.servicio.administracion.VentanaServicio;

@RestController
@RequestMapping({"/api/com-ventanas", "/api/ventanas"})
